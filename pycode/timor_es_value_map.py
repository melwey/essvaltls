...
ESval = QgsVectorLayer(
    ...
    #"Ecosystem Services value","ogr")
     "file:///Users/mela/Documents/JRC/BIOPAMA/ESS/essvaltls/output/global_mainESvalue.csv?type=csv&trimFields=Yes&detectTypes=Yes&geomType=none&subsetIndex=no&watchFile=no",
